...
<div class="section">
	<div class="container">
    	<div class="row">
			<div class="col-12">
            	<div class="row shop_container" id="categoryListById">
...
<script>
    ...
    async function getCategoryListById(){
        let urlParams = new URLSearchParams(window.location.search);
        let id = urlParams.get('id');

        let response = await axios.get('/productlistbycategory/'+id);
        $(".preloader").delay(700).fadeOut(700).addClass('loaded');

        $("#categoryListById").empty();
        ...
        response.data['data'].forEach((item, index) => {
            let singleCat = `<div class="col-lg-3 col-md-4 col-6">
                    ...
                    $("#categoryListById").append(singleCat);
