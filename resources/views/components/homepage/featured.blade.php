...
<script>
    ...
    async function getPopularProducts(){
        let response = await axios.get('/productlistbyremark/popular');
    ...
    async function getNewProducts(){
        let response = await axios.get('/productlistbyremark/new');
        $("#newProduct").empty();
    ...
    async function getTopProducts(){
        let response = await axios.get('/productlistbyremark/top');
        $("#topProduct").empty();
    ...
    async function getSpecialProducts(){
        let response = await axios.get('/productlistbyremark/special');
    ...
    async function getTrendingProducts(){
        let response = await axios.get('/productlistbyremark/trending');
