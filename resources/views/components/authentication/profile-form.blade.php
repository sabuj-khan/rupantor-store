...
<script>
    ...
    async function customerProfileCreate(){
        ...
        let response = await axios.post('createuserProfile', profileData);
    ...
    async function getCustomerProfileInfo(){
        let response = await axios.get('/readuserProfile');

        if(response.data['data'] !== null){
            document.getElementById("cus_name").value = response.data['data']['cus_name']
            document.getElementById("cus_add").value = response.data['data']['cus_add']
            document.getElementById("cus_city").value = response.data['data']['cus_city']
            document.getElementById("cus_state").value = response.data['data']['cus_state']
            document.getElementById("cus_postcode").value = response.data['data']['cus_postcode']
            document.getElementById("cus_country").value = response.data['data']['cus_country']
            document.getElementById("cus_phone").value = response.data['data']['cus_phone']
            document.getElementById("cus_fax").value = response.data['data']['cus_fax']

            document.getElementById("ship_name").value = response.data['data']['ship_name']
            document.getElementById("ship_add").value = response.data['data']['ship_add']
            document.getElementById("ship_city").value = response.data['data']['ship_city']
            document.getElementById("ship_state").value = response.data['data']['ship_state']
            document.getElementById("ship_postcode").value = response.data['data']['ship_postcode']
            document.getElementById("ship_country").value = response.data['data']['ship_country']
            document.getElementById("ship_phone").value = response.data['data']['ship_phone']
        }
