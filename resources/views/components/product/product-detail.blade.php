                    ...
                    <div class="cart_extra">
                        <div class="cart-product-quantity">
                            <div class="quantity">
                                ...
                                <input id="p_qty" type="text" name="quantity" value="0" title="Qty" class="qty" size="4">
...
<script>
    ...
    async function getProductDetails(){
        ...
        document.getElementById("img1").src = response.data['data']['img1']
        document.getElementById("img2").src = response.data['data']['img2']
        document.getElementById("img3").src = response.data['data']['img3']
        document.getElementById("img4").src = response.data['data']['img4']
        ...
        document.getElementById("p_des").innerText = response.data['data']['product']['short_des']
        document.getElementById("categoryD").innerText = response.data['data']['product']['category']['categoryName']
        ...
        $("#img1").on('click', function(){
            $("#product_img").attr('src', response.data['data']['img1']);
        });
        $("#img2").on('click', function(){
            $("#product_img").attr('src', response.data['data']['img2']);
        });
        $("#img3").on('click', function(){
            $("#product_img").attr('src', response.data['data']['img3']);
        });
        $("#img4").on('click', function(){
            $("#product_img").attr('src', response.data['data']['img4']);
        });
    ...
    async function addToCartList(){
        ...
        if(p_size.length === 0){
            ...
            let response = await axios.post('/create-productcart', cartData);
    ...
    async function addToWishList(){
            ...
            let response = await axios.get("/wish-product-create/"+id);
            $(".preloader").delay(90).fadeOut(100).addClass('loaded');
